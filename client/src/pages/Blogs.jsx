...
//               src="https://imgs.search.brave.com/-1uUuGEoE3q_S0siodb1c03LB2Pt28aQK_HUPTVQzhc/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZXMudW5zcGxhc2gu/Y29tL3Bob3RvLTE1/ODk3ODk2OTIyNDgt/MTVhZmJmMmRjZGEx/P3E9ODAmdz0xMDAw/JmF1dG89Zm9ybWF0/JmZpdD1jcm9wJml4/bGliPXJiLTQuMC4z/Jml4aWQ9TTN3eE1q/QTNmREI4TUh4elpX/RnlZMmg4TW54OFpt/bHlaU1V5TUcxaGJu/eGxibnd3Zkh3d2ZI/eDhNQT09"
//               alt="fire Brigade"
//               className="rounded-3xl h-80 mr-20"
//             />
//           </div>
//           <div className="max-w-lg ">
//             <h1 className="text-4xl font-serif">Power Plants</h1>
//             <br />
...
//           <div className="max-w-lg ">
//             <h1 className="text-4xl font-serif">Building & Construction</h1>
//             <br />
//             <p className="text-gray-600">
...
//             <h1 className="text-4xl font-serif">Restaurants & Server Room</h1>
//             <br />
//             <p className="text-gray-600">
...
//           </div>
//           <div className="max-w-lg ">
//             <h1 className="text-4xl font-serif">Residential Areas</h1>
//             <br />
//             <p className="text-gray-600">
...
export default function Blogs() {
  const blogPosts = [
    {
      title: "10 Tips for Maximizing Productivity in the Workplace",
